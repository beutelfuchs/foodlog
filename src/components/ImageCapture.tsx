  ...
  return (
    <div className="flex items-center gap-3">
      <button
        ...
        className="w-20 h-20 rounded-xl border-2 border-dashed border-neutral-600 hover:border-cyan-500/50 flex items-center justify-center overflow-hidden bg-neutral-800 shrink-0 transition-colors"
      >
        {previewUrl ? (
